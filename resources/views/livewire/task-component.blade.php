    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="w-full">
                    ...
                    @if($isOpen)
                        <div class="fixed inset-0 flex items-center justify-center z-50">
                            ...
                            <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                                ...
                                <form wire:submit.prevent="{{ $taskId ? 'update' : 'store' }}">
                                    <div class="mb-4">
                ...
                <div class="relative w-full overflow-x-auto shadow-md sm:rounded-lg mt-3">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        @empty
                            <tr class="text-center h-12 bg-white border-b dark:bg-gray-900 dark:border-gray-700">
